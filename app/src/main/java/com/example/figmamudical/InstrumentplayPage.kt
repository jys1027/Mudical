...
import com.example.figmamudical.databinding.FragmentInstrumentplayPageBinding


class InstrumentplayPage : Fragment() {
    ...
    private var _binding: FragmentInstrumentplayPageBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentInstrumentplayPageBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.apply {
            // Assign the fragment
            instrumentplaypageFragment = this@InstrumentplayPage
        }
    }
    ...
    fun confirmSong() {
        ...
        findNavController().navigate(R.id.action_instrumentplayPage_to_instrumentplayExplainPage)
    }
}